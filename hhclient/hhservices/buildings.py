...
class BuildingManager(base.Manager):
    ...
    def activate_application(self, building_id, application_id):
    ...
    def deactivate_application(self, building_id, application_id):
        url = '{}/{}/applications/{}'.format(self.__resource_url__,
                                             building_id,
                                             application_id)

        response, status_code = self.api.http_client.delete(url)
